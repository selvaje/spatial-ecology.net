...
The Research Group "Global Freshwater Biodiversity, Biogeography & Conservation", also named "us", "we", or "our" in this Privacy Policy, operates the https://hydrography.org website.
...
__Licenses for the usage of the datasets__

Both datasets described on this website are protected by the Creative Commons Attribution-NonCommercial 4.0 International License **(CC BY-NC 4.0)**. To view a copy of this license, visit <a href="http://creativecommons.org/licenses/by-nc/4.0">http://creativecommons.org/licenses/by-nc/4.0</a>.
